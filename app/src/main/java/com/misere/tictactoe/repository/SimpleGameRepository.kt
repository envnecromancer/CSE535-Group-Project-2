...
class SimpleGameRepository private constructor(context: Context) {
    ...
    companion object {
        @Volatile
        private var INSTANCE: SimpleGameRepository? = null
        
        fun getInstance(context: Context): SimpleGameRepository {
            return INSTANCE ?: synchronized(this) {
                val instance = SimpleGameRepository(context.applicationContext)
                INSTANCE = instance
                instance
            }
        }
